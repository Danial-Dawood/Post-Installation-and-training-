...
- Item 7.25 - To create New users We will Have to Switch over to the "Admin Panel" so click at the very top right of the screen.(Right next to your username it will say what panel youre are in.) Then go over "Users" and under "User Directory" click "Add User" andc create two new users (should look somthing like this when you're done) <img width="1440" alt="Screen Shot 2023-11-01 at 4 28 17 PM" src="https://github.com/Danial-Dawood/Post-Installation-and-training-/assets/149525309/566c9910-5925-4a28-815d-4c16481bef34">
